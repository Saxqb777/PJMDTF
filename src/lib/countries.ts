...
// Every country on earth, with its dialling code. A member in Rwanda must be
// able to fill this form; a short list of "likely" countries is how that fails.
// Sources: world-countries (ISO 3166 common names) + country-telephone-data
// (dialling codes), joined on ISO 3166-1 alpha-2.

export type Country = {
  /** ISO 3166-1 alpha-2, e.g. "IN". This is what the form posts. */
  iso: string;
...
/** India and the Gulf first — most members are in one of these. */
export const PINNED_COUNTRIES: readonly Country[] = [
...
export const OTHER_COUNTRIES: readonly Country[] = [
  ...
  { iso: "TF", name: "French Southern and Antarctic Lands", dial: "+262" },
...
export const COUNTRIES: readonly Country[] = [...PINNED_COUNTRIES, ...OTHER_COUNTRIES];

const BY_ISO = new Map(COUNTRIES.map((c) => [c.iso, c]));

/** Look up a country by ISO code. Returns undefined for anything unrecognised. */
